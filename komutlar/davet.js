...
exports.run = (client, message, params) => {
  if (!params[0]) {
	...
	message.channel.send({embed: {
            ...
            title: "",
            description: "[Davet Linkim](https://discord.com/oauth2/authorize?client_id=793842983007027200&scope=bot&permissions=805314622) \n[Destek Sunucusu](https://discord.gg/srkpVNxy7u)",
            fields: [
            ],
            timestamp: new Date(),
            footer: {
